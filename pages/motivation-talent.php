...
$_SESSION['site']="mytalent.php?page=motivation-talent";
    ...
    <div class="master-wrapper">
      <section>
            <div class="section-inner">
                ...
                <div class="row mb50">
                  <?php
                                 $req = $bdd->query('SELECT video_title, video_description, file_way ,date_format(date,\'%d/%m/%y à %Hh%i\') AS date_fr FROM talent_video WHERE page="Motivation-talent"');
